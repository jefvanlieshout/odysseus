...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "proxmox": "Read-only Proxmox VE homelab monitoring. Check node CPU/RAM and health, VMs, LXCs, guest status/config, storage capacity, recent tasks/errors, and diagnostics. Use for questions such as how is my server doing, is Immich running, what is VM 101, or are Proxmox jobs failing. Never performs power or destructive actions.",
