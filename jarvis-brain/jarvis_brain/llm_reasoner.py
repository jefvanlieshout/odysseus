        ...
        *,
        ...
        payload = self._call(
            ...
            system=(
                ...
                "NEIGHBORS. Return only one relation: NOVEL, MATCH, EXTENSION, STATE_CHANGE, CONTRADICTION, "
                "CONTEXT_VARIANT, or UNCERTAIN. target_memory_uuid must be exactly one UUID from NEIGHBORS when "
                "the relation targets an existing memory; otherwise return an empty string. "
